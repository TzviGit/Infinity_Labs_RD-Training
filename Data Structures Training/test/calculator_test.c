/******************************************************************************
* Author        Yinon and Binyomin
* Reviewer      -----------
* Description   Test for the Calculator built on a state machine design.
* Date          Oct 17, 2021
* Group         OL110
...
int main()
{
    ...
    exp_test_case_t  test_cases[] = {
            ...
            {"2^3-()2 * 7 ^ 2)^(2)", -9596, CALC_SYNTAX_ERROR},
    ...
    {
        status = Calculate(test_cases[i].expression, &res, calc);

...
sem_t prod_semaphore = {0};

sem_t capacity_semaphore = {0};
...
int main(void)
{
    ...
    sem_init(&prod_semaphore, 0, 0);
    sem_init(&capacity_semaphore, 0, MAX_CAPACITY);
